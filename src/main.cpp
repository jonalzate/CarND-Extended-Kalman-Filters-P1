...
// Directory path to save output file to compare to ground truth 
std::string outFileName = "../data/obj_pose-laser-radar-ekf-output.txt";
...
int main()
{
  ...
  ofstream out_file_(outFileName.c_str(), ofstream::out);
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
    	  ...
    	  if (sensor_type.compare("L") == 0) {
          		...
          		measurements_list.push_back(meas_package);
